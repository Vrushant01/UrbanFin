    ...
    >
      <div className="max-w-7xl mx-auto space-y-6">
          ...
          <form onSubmit={handleSearchSubmit} className="flex flex-col sm:flex-row gap-3">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-slate-200 rounded-xl text-sm font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 bg-slate-50/50 hover:bg-white transition-colors"
              />
            </div>
        ...
        <div className="flex justify-between items-center px-1">
          ...
          <Link to="/purchase/orders" className="text-sm font-semibold text-blue-600 hover:text-blue-800 flex items-center gap-1">
                ...
                <div className="p-6 pt-0 mt-auto">
                  <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
                    ...
                    <Button 
                      ...
                      className="gap-2 font-bold text-xs px-4 py-2.5 shadow-sm"
        ...
        {selectedItem && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-xs p-4">
            <div className="bg-white w-full max-w-lg rounded-xl shadow-2xl border border-slate-200 overflow-hidden animate-scale-in">
              <div className="p-6 bg-gradient-to-r from-blue-900 to-blue-800 text-white flex justify-between items-start">
                <div>
                  <div className="text-xs font-bold uppercase tracking-wider text-blue-200">Send Sourcing Request</div>
              ...
              <div className="p-6 space-y-5">
                {/* Vendor Summary */}
                <div className="bg-blue-50/70 p-4 rounded-xl border border-blue-100 flex justify-between items-center text-sm">
                  <div>
                    <div className="text-xs text-blue-600 font-bold uppercase">Target Vendor</div>
                    <div className="font-black text-blue-950 text-base">{selectedItem.vendorName}</div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      className="w-full h-11 px-3 border border-slate-300 rounded-xl text-base font-bold text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full h-11 px-3 border border-slate-300 rounded-xl text-sm font-medium bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
